...
NEW_CORPUS = "Mark"  # The corpus where we'll do detailed analysis; formatting may be critical for get_.
...
tb = topicBuilder.TopicBuilder(NEW_CORPUS, new_texts, USE_GRAPH_DB, MAX_TOPICS)
new_topics = tb.nouns()
